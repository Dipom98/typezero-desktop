...
This guide covers how to set up the development environment and build TypeZero from source across different platforms.
...
```bash
git clone git@github.com:cjpais/TypeZero.git
cd TypeZero
```
