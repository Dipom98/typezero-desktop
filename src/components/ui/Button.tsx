...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary:
      "bg-accent-muted border-border hover:bg-mid-gray/10 hover:border-logo-primary focus:outline-none",
    danger:
    ...
    ghost:
      "text-current border-transparent hover:bg-accent-muted hover:border-logo-primary focus:bg-mid-gray/20",
  };
