...
import { ShortcutInput as PostProcessShortcutInput } from "../ShortcutInput";
...
const PostProcessingSettingsPromptsComponent: React.FC = () => {
  ...
  const selectedPrompt =
    prompts.find((prompt: any) => prompt.id === selectedPromptId) || null;
        ...
        {!isCreating && hasPrompts && selectedPrompt && (
          <div className="mac-card p-4 bg-black/5 dark:bg-white/5 space-y-4 animate-in slide-in-from-top-2 duration-200">
            ...
            <div className="space-y-1.5 flex flex-col">
              ...
              />
              <p
                className="text-xs text-text-muted/70 italic px-1"
  ...
  return (
    <div className="w-full space-y-12">
      <div className="space-y-1 mb-8">
        <h1 className="mac-title text-3xl">{t("settings.postProcessing.title")}</h1>
        <p className="mac-muted text-sm">Configure AI-powered text refinement and custom prompts.</p>
      </div>
