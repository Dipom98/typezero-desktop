...
import { TypeZeroKeysShortcutInput } from "./TypeZeroKeysShortcutInput";
 ...
 * - "type_zero_keys": Uses TypeZeroKeysShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "type_zero_keys") {
    return <TypeZeroKeysShortcutInput {...props} />;
  }
