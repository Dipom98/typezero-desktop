...
const settingUpdaters: {
  ...
  telemetry_enabled: (value) =>
    commands.changeTelemetrySetting(value as boolean),
  beta_channel_enabled: (value) =>
    commands.changeBetaChannelSetting(value as boolean),
  ...
  theme: (value) => commands.changeAppThemeSetting(value as string),
  tts_enabled: (value) =>
    commands.changeTtsEnabledSetting(value as boolean),
  tts_voice: (value) => commands.changeTtsVoiceSetting(value as string),
