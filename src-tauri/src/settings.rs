...
impl Default for KeyboardImplementation {
    fn default() -> Self {
        // Default to TypeZeroKeys only on macOS where it's well-tested.
        // Windows and Linux use Tauri by default (typezero-keys not sufficiently tested yet).
        #[cfg(target_os = "macos")]
        return KeyboardImplementation::TypeZeroKeys;
...
fn default_beta_channel_enabled() -> bool {
    false
}
