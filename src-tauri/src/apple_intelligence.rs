...
// Mock implementations for when Swift bridge is disabled
pub fn is_apple_intelligence_available() -> c_int { 0 }
pub unsafe fn process_text_with_apple_llm(_: *const c_char, _: i32) -> *mut AppleLLMResponse { std::ptr::null_mut() }
pub unsafe fn free_apple_llm_response(_: *mut AppleLLMResponse) {}
