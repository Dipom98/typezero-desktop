{
  description = "TypeZero - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          typezero = pkgs.rustPlatform.buildRustPackage {
            pname = "typezero";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/cjpais/TypeZero";
              license = lib.licenses.mit;
              mainProgram = "typezero";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.typezero;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "TypeZero development environment"
              bun install
